...
#define kRatioX ([UIScreen mainScreen].bounds.size.width / 375.)
#define kRatioY ([UIScreen mainScreen].bounds.size.height / 667.)

///------ Ratio(Point)基于iPhone5s ------
#define kRatioW ([UIScreen mainScreen].bounds.size.width / 320)
#define kRatioH ([UIScreen mainScreen].bounds.size.height / 568)
